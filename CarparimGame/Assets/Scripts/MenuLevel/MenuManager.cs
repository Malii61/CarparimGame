...
public class MenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sesPaneli.GetComponent<RectTransform>().localPosition=new Vector3(6,-127,0);
    ...
    public void AyarlariYap(){
        ...
        if(!sesPaneliAcikmi){
            sesPaneli.GetComponent<RectTransform>().DOLocalMoveY(-207,0.5f);
            sesPaneliAcikmi=true;
        }
        else{
            sesPaneli.GetComponent<RectTransform>().DOLocalMoveY(-127,0.5f);
            sesPaneliAcikmi=false;
        }
    }
